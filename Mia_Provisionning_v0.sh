...
NODES=(
    ...
    "https://github.com/cubiq/PuLID_ComfyUI"                         # PuLID native (cubiq) — PulidEvaClipLoader, ApplyPulidFlux etc.
    # "https://github.com/sipie800/ComfyUI-PuLID-Flux-Enhanced"     # BROKEN — 4 node conflicts, do not use
    "https://github.com/balazik/ComfyUI-PuLID-Flux-Enhanced"      # BROKEN — install fails on vast.ai
    ...
    # Skin enhancement stack (v6_skin workflow)
    "https://github.com/Jonseed/ComfyUI-Detail-Daemon"              # LyingSigma + DetailDaemon sampler nodes
    "https://github.com/ssitu/ComfyUI_UltimateSDUpscale"            # Tiled upscale with skin detail pass
...
UNET_MODELS=(
    ...
    # FLUX.1-Krea-dev fp8 — 11.9 GB, fallback for 24 GB VRAM without offloading
...
UPSCALE_MODELS=(
    # Primary for portraits — used in v6 main workflow
